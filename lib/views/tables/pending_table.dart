                                  ...
                                  onTap: () async {
                                    ...
                                    switch (audit.audittype) {
                                      case ConstantStrings.ERBTECH:
                                        ...
                                        String jsonData = jsonEncode(data);
                                        await apiProvider.getAuditScreenData(
                                            jsonData, context);
                                        ...
                                        Future.delayed(Duration(seconds: 1),
                                          ...
                                          if (auditId == "10000000006") {
                                            CommonFunctions.showMessageDialog(
                                                context: context,
                                                message:
                                                    "You are not in radius specified for this Station. Please launch Audit when you are at Station Location",
                                                onYesPressed: () {});
                                          } else {
                                            Navigator.pushNamed(context,
                                                Routenames.ERBScreen_Tech);
                                          }
                                        });
                                        break;
                                      ...
                                      case ConstantStrings.FUEL:
                                        ...
                                        prefs.setString(ConstantStrings.selectedStockAuditID, '$auditId');
