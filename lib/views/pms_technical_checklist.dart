...
class PMSTechnicalCheckList extends StatefulWidget {
  @override
  _PMSTechnicalCheckListState createState() => _PMSTechnicalCheckListState();
}

class _PMSTechnicalCheckListState extends State<PMSTechnicalCheckList> {
  ...
  Widget build(BuildContext context) {
    var stockAuditsHeaderDetails = Provider.of<AuditProvider>(context)
        .stockAuditsHeaderDetails; // Audit header details for Fuel->PMS
    var stockAuditsFuelPMSNozzleUSTDetails = Provider.of<AuditProvider>(context)
        .stockAuditsFuelPMSNozzleUSTDetails; // Fuel->PMS re-consilation data
    var nozzelsTextControllers = Provider.of<AuditProvider>(context)
        .nozzelsUstsTextControllers; // Fuel->PMS textControllers

    var ustsTextControllers = Provider.of<AuditProvider>(context)
        .ustTextControllers; // Fuel->PMS textControllers

    var qnqTextControllers = Provider.of<AuditProvider>(context)
        .ustQnQTextControllers; // Fuel->PMS textControllers Q&Q
    var ddrrTextControllers = Provider.of<AuditProvider>(context)
        .ddrrTextControllers; // Fuel->PMS textControllers DDRR

    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Product PMS Checklist',
          style: TextStyle(
            fontFamily: 'Montserrat',
                  ...
                  title: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          'Stock Reconciliation(All Figures in ltrs)',
                          style: _expandHeaderTextStyle
                        ),
                      ),
                    ],
